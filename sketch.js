...
var arrowShootingSound;
var arrow_missingSound;
var isGameOver = false;

function preload() {
  backgroundImg = loadImage("./assets/background.gif");

  arrowShootingSound = loadSound("./assets/arrow shoot.mp3");

  arrow_missingSound = loadSound("./assets/missed.mp3");
...
if( computerArcherLife === 0 || (!playerArcherLife === 0)){
